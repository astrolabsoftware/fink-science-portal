...
def display_skymap_gw(nclick, gw_data, credible_level, superevent_name, searchurl):
    ...
    if len(pdf) > 0:
        ...
        # Aladin lite
        img += """var a = A.aladin('#aladin-lite-div-skymap-gw', {{target: '{} {}', survey: 'P/PanSTARRS/DR1/color/z/zg/g', showReticle: true, allowFullZoomout: true, showContextMenu: true, showCooGrid: true, fov: 360}});""".format(ra0, dec0)
