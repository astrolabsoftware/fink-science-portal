...
"""
msg_intro = """
Fink science portal allows accessing public time-domain data from [ZTF public alert stream](https://www.ztf.caltech.edu/) and, in the future, [Vera C. Rubin Observatory](https://lsst.org/). The portal uses Fink's aggregated data base at the end of each observing night which is also accessible using our rest API.

Our database contains all alerts that pass basic quality cuts from the data stream, with Fink's added values like coordinate cross-match with the closest CDS SIMBAD objects within 1'', machine learning classification scores and basic features. We provide candidate filtered streams based on collaborations with researchers.

For automatic filtered data streams within minutes of observations, please contact us at contact@fink-broker.org
...
layout = html.Div(
    [
        dbc.Container(
            [
                dbc.Row([dbc.Col(html.H2("Fink"), className="mb-5 mt-5")]),
                dbc.Row(
                ...
                dbc.Row([dbc.Col(html.H2("Fink results"), className="mb-5 mt-5")]),
                dbc.Row(
                    [
                ...
                dbc.Row([dbc.Col(html.H2("Acknowledgments"), className="mb-5 mt-5")]),
                dbc.Row(
                ...
                dbc.Row(
                    [
                        ...
                        html.Img(
                            src="/assets/lsstfr.png", height="100px", width="200px"
                        ),
