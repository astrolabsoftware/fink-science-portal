...
def display_skymap(data, columns, is_open):
    ...
    if len(data) > 0:
        ...
        # Aladin lite
        img += """var a = A.aladin('#aladin-lite-div-skymap', {{target: '{} {}', survey: 'P/PanSTARRS/DR1/color/z/zg/g', showReticle: true, allowFullZoomout: true, showContextMenu: true, showCooGrid: true, fov: 360}});""".format(ra0, dec0)
